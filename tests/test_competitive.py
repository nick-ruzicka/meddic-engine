...
class TestAnalysis:
    ...
    def test_parse_brief_json_valid(self):
        ...
        data = {
            ...
            "weakness_vs_platform": "Narrower document types",
            "strength_vs_platform": "Lower price point",
    ...
    def test_parse_brief_json_valid_sourced_format(self):
        ...
        data = {
            ...
            "weakness_vs_platform": {"text": "Narrower document types", "sources": ["https://example.com"]},
            "strength_vs_platform": {"text": "Lower price point", "sources": ["https://example.com/pricing"]},
            "recent_moves": [
    ...
    def test_parse_brief_json_extracts_from_markdown(self):
        ...
        data = {
            ...
            "weakness_vs_platform": "Less accurate",
            "strength_vs_platform": "Cheaper",
    ...
    def test_parse_brief_json_extracts_from_markdown_sourced(self):
        ...
        data = {
            ...
            "weakness_vs_platform": {"text": "Less accurate", "sources": []},
            "strength_vs_platform": {"text": "Cheaper", "sources": []},
